...
function NavBar() {
  ...
  return (
    <nav className="navbar navbar-light bg-light">
      <Link to="/" style={{textDecoration: "none", color: "black"}} className="navbar-brand d-flex justify-content-start mx-4">
        <AiFillHome style={{fontSize: "25px", color: "#f55a98"}} className="mx-2"/>
